          ...
          >
            ...
            >
              ...
              <Text className="text-slate-400 text-sm leading-relaxed mb-2">
                Fill the 4×4 grid with numbers 1–4. No number can repeat in any row or column.
              </Text>
              <Text className="text-slate-400 text-sm leading-relaxed mb-2">
                Each outlined cage shows a target number and an operation (+  −  ×  ÷). The numbers inside the cage must produce that target using the given operation.
              </Text>
              <Text className="text-slate-400 text-sm leading-relaxed">
                Tap a cell to select it, then tap a number below the grid to fill it in.
              </Text>
