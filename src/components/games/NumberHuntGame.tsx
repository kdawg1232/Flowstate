        ...
        {gameState === GameState.IDLE ? (
          ...
          >
            <View className="relative mb-6 items-center justify-center">
              <GameIconGlow color="#6366f1" glowId="numberHuntGlow" />
              <View className={`w-20 h-20 ${isDark ? 'bg-black border-white/10 shadow-[0_0_30px_rgba(99,102,241,0.2)]' : 'bg-white border-indigo-100 shadow-sm'} rounded-3xl items-center justify-center border`}>
