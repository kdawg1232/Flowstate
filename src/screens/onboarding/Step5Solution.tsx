...
const MILESTONES = [
  { val: 250, label: "Focused", perk: "10 Minutes per Hour", icon: Zap },
  { val: 500, label: "High Performance", perk: "15 Minutes per Hour", icon: Zap },
  { val: 750, label: "Peak Calibration", perk: "20 Minutes per Hour", icon: Zap },
  { val: 1000, label: "FLOWSTATE", perk: "Unlimited Access", icon: Shield }
];
